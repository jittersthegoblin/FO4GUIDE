const factionData={
railroad:{title:'Railroad',intro:'Core Railroad storyline plus Prima-classified miscellaneous and radiant Railroad work.',main:[['Road to Freedom','Main','f_rr_road'],['Tradecraft','Main','f_rr_trade'],['Operation Ticonderoga','Main','f_rr_ticon'],['Underground Undercover','Main','f_rr_uu'],['Burning Cover','Main / conditional','f_rr_burning'],['Precipice of War','Main','f_rr_precipice'],["Rockets' Red Glare",'Main','f_rr_redglare'],['The Nuclear Option (Railroad)','Main','f_rr_nuclear']],side:[['Boston After Dark','Miscellaneous','f_rr_bad'],['Memory Interrupted','Miscellaneous','f_rr_memory'],['Kicked out of the Railroad','Miscellaneous / conditional','f_rr_kicked'],["Butcher's Bill",'Radiant','f_rr_b1'],["Butcher's Bill 2",'Radiant','f_rr_b2'],['Mercer Safehouse','Radiant / settlement','f_rr_mercer'],['Jackpot','Radiant','f_rr_jackpot'],['Concierge','Radiant','f_rr_concierge'],['Weathervane','Radiant','f_rr_weather'],['Randolph Safehouse','Radiant chain','f_rr_randolph'],['Variable Removal','Radiant','f_rr_variable'],['To the Mattresses','Radiant chain','f_rr_mattress'],['Lost Soul','Radiant','f_rr_lost'],['High Ground','Radiant','f_rr_high'],['A Clean Equation','Radiant','f_rr_clean']]},

minutemen:{title:'Minutemen',intro:'Prima separates Minutemen Main quests from Radiant Recruitment/Ownership jobs. Settlement Location quests are shown as optional connected content.',main:[['When Freedom Calls','Main','f_mm_wfc'],['Sanctuary','Main','f_mm_san'],['The Sight','Main · optional in practice','f_mm_sight'],['Taking Independence','Main','f_mm_independence'],['Old Guns','Main','f_mm_oldguns'],['Inside Job','Main','f_mm_inside'],['Form Ranks','Main','f_mm_form'],['Defend the Castle','Main','f_mm_defend'],['The Nuclear Option (Minutemen)','Main','f_mm_nuclear'],['With Our Powers Combined','Main · optional anti-Brotherhood branch','f_mm_combined']],side:[['The First Step','Radiant Recruitment','f_mm_first'],['Abernathy Farm: Retribution','Radiant Recruitment','f_mm_abernathy'],['Raider Troubles','Radiant Recruitment','f_mm_raider'],['Ghoul Problem','Radiant Recruitment','f_mm_ghoul'],['Greenskins','Radiant Recruitment','f_mm_green'],['Kidnapping','Radiant Recruitment','f_mm_kidnap'],['Clearing the Way','Radiant Recruitment','f_mm_clear'],['Taking Point','Radiant Recruitment','f_mm_point'],['Rogue Courser','Radiant Recruitment','f_mm_courser'],['Resettle Refugees','Radiant Recruitment','f_mm_refugees'],['Defend a Settlement','Radiant Ownership','f_mm_defsettle'],['Defend Artillery','Radiant Ownership','f_mm_art'],['Stop the Raiding','Radiant Ownership','f_mm_stop'],['Kidnapped Trader','Radiant Ownership','f_mm_trader'],['Water','Radiant Ownership','f_mm_waterjob'],['Food','Radiant Ownership','f_mm_foodjob'],['Power','Radiant Ownership','f_mm_powerjob'],['Suspected Synth','Radiant Ownership','f_mm_synth'],['Returning the Favor','Location / settlement','f_mm_return'],['Out of the Fire','Location / settlement','f_mm_fire'],['Troubled Waters','Location / settlement','f_mm_water']]},

bos:{title:'Brotherhood of Steel',intro:'Brotherhood Main quests plus Prima-classified Miscellaneous and Radiant Prydwen/patrol work.',main:[['Reveille','Main / conditional intro','f_bos_reveille'],['Fire Support','Main','f_bos_fire'],['Call to Arms','Main','f_bos_call'],['Semper Invicta','Main','f_bos_semper'],['Shadow of Steel','Main','f_bos_shadow'],['Tour of Duty','Main','f_bos_tour'],['Show No Mercy','Main','f_bos_mercy'],['From Within','Main','f_bos_from'],['Outside the Wire','Main','f_bos_wire'],['Liberty Reprimed','Main','f_bos_liberty'],['Blind Betrayal','Main','f_bos_blind'],['Tactical Thinking','Danger','f_bos_tactical'],['Spoils of War','Danger','f_bos_spoils'],['Ad Victoriam','Main','f_bos_ad'],['The Nuclear Option (Brotherhood)','Main','f_bos_nuclear'],['A New Dawn','Main / post-ending','f_bos_dawn']],side:[['The Lost Patrol','Miscellaneous','f_bos_lost'],['Duty or Dishonor','Miscellaneous','f_bos_duty'],['A Loose End','Miscellaneous','f_bos_loose'],['Blood Bank','Miscellaneous / repeatable','f_bos_blood'],['Getting Technical','Miscellaneous / repeatable','f_bos_tech'],['Reactor Coolant','Miscellaneous / repeatable','f_bos_coolant'],['Cleansing the Commonwealth','Radiant','f_bos_clean'],['Quartermastery','Radiant','f_bos_quarter'],['Feeding the Troops','Radiant','f_bos_feed'],['Leading by Example','Radiant','f_bos_lead'],['Learning Curve','Radiant','f_bos_curve']]},

institute:{title:'Institute',intro:'Institute Main storyline plus Prima-classified Miscellaneous directorate work and repeating Institute assignments.',main:[['Institutionalized','Main','f_i_inst'],['Synth Retention','Main','f_i_synth'],['The Battle of Bunker Hill','Main','f_i_bunker'],['Mankind - Redefined','Main','f_i_mankind'],['Mass Fusion','Danger','f_i_mass'],['Pinned','Main','f_i_pinned'],['Powering Up','Main','f_i_power'],['End of the Line','Danger','f_i_end'],['Airship Down','Main','f_i_air'],['Nuclear Family','Main','f_i_nuclear']],side:[['Building a Better Crop','Miscellaneous','f_i_crop'],['A House Divided','Miscellaneous','f_i_house'],["Plugging a Leak",'Miscellaneous','f_i_leak'],['Banished from the Institute','Miscellaneous / conditional','f_i_banished'],['Hypothesis','Radiant','f_i_hyp'],['Pest Control','Radiant','f_i_pest'],['Reclamation','Radiant','f_i_reclaim'],['Appropriation','Radiant','f_i_approp'],['Political Leanings','Radiant','f_i_political']]},

undecided:{title:'All Factions',intro:'You have not committed. Use this section to sample optional faction jobs before lockouts.',main:[],side:[['Railroad: Boston After Dark / Memory Interrupted / Jackpot','Optional Railroad Misc/Radiant work','f_all_rr'],['Brotherhood: Lost Patrol / Duty or Dishonor / A Loose End','Optional Brotherhood Misc work','f_all_bos'],['Minutemen: First Step + recruitment, ownership and settlement Location jobs','Optional Minutemen work','f_all_mm'],['Institute Miscellaneous/radiant jobs after Institutionalized','Optional Institute work','f_all_i']]}
};
...
"Butcher's Bill":'A Railroad radiant assignment investigating a compromised operation.',
"Butcher's Bill 2":'A follow-up Railroad radiant assignment involving another compromised operation.',
